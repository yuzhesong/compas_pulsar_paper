...
class pythonProgramOptions:
    ...
    def __init__(self, config_file='proper.yaml', grid_filename=None, random_seed_filename='randomSeed.txt', output_directory=None):
        ...
        if (compas_executable_override is None):
            ...
            git_directory = '/home/ysong/git_repos/COMPAS/'#os.getenv('COMPAS_ROOT_DIR')#environ.get
            print(git_directory)
